    ...
    def reconstruct_communes(self):
        ...
        population = df[
            [
                "ID_COMMUNE",
                "POP_2020",
                "TAUX_POP_MOINS_15_2020",
                "TAUX_POP_PLUS_65_2020",
                "TAUX_POP_PLUS_80_2020",
                "TAUX_POP_25_64_2020",
                "NBR_FEMME_55_64_2020",
                "NBR_HOMME_55_64_2020",
            ]
        ].copy()
        population["TAUX_POP_15_24"] = np.where(
            df["TAUX_POP_MOINS_15_2020"].notnull(),
            (
                100
                - df[
                    [
        ...
        population["TAUX_POP_65_74"] = (
            df["TAUX_POP_PLUS_65_2020"] - df["TAUX_POP_PLUS_75_2020"]
        )
        population["TAUX_POP_75_79"] = (
            df["TAUX_POP_PLUS_75_2020"] - df["TAUX_POP_PLUS_80_2020"]
        )
        population["TAUX_POP_55_64"] = (
            df[["NBR_FEMME_55_64_2020", "NBR_HOMME_55_64_2020"]].sum(axis=1)
            / df["POP_2020"]
        )
        population["TAUX_POP_25_54"] = (
            population["TAUX_POP_25_64_2020"] - population["TAUX_POP_55_64"]
        )

        population["AGE_MOYEN"] = (
            population["TAUX_POP_MOINS_15_2020"] * 7.5
            ...
            + population["TAUX_POP_PLUS_80_2020"] * 92
        ) / 100
        ...
        gender_age["TAUX_HOMME_POP"] = (
            gender_age["NBR_HOMMES_2020"] / gender_age["POP_2020"]
        )
        gender_age["TAUX_HOMME_POP_15_24"] = gender_age[
            "NBR_HOMME_15_24_2020"
        ] / gender_age[["NBR_HOMME_15_24_2020", "NBR_FEMME_15_24_2020"]].sum(axis=1)
        gender_age["TAUX_HOMME_POP_25_54"] = gender_age[
            "NBR_HOMME_25_54_2020"
        ] / gender_age[["NBR_HOMME_55_64_2020", "NBR_FEMME_25_54_2020"]].sum(axis=1)
        gender_age["TAUX_HOMME_POP_55_64"] = gender_age[
            "NBR_HOMME_55_64_2020"
        ] / gender_age[["NBR_HOMME_55_64_2020", "NBR_FEMME_55_64_2020"]].sum(axis=1)
        gender_age["NBR_HOMME_MOINS_15_2020"] = (
            gender_age["NBR_HOMME_15_24_2020"] * 3 / 2
        ).round(0)
        gender_age["TAUX_HOMME_POP_15_MOINS"] = gender_age[
            "NBR_HOMME_MOINS_15_2020"
        ] / (gender_age["POP_2020"] * gender_age["TAUX_POP_MOINS_15_2020"] / 100)
        gender_age["TAUX_HOMME_POP_65_PLUS"] = (
            gender_age["NBR_HOMMES_2020"]
            - gender_age[
                ["NBR_HOMME_15_24_2020", "NBR_HOMME_25_54_2020", "NBR_HOMME_55_64_2020"]
            ].sum(axis=1)
        ).clip(0, None) / gender_age["NBR_HOMMES_2020"]

        # TODO: approximate + 65
        gender_age = gender_age[
            [
                "ID_COMMUNE",
                "TAUX_HOMME_POP_15_MOINS",
                "TAUX_HOMME_POP_15_24",
                "TAUX_HOMME_POP_25_54",
                "TAUX_HOMME_POP_55_64",
                "TAUX_HOMME_POP_65_PLUS",
            ]
        ]
