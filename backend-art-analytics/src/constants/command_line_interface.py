...
WEBPAGE_KWARG = {
    ...
    "show_default": True,
    "required": True,
    "help": ("The URL to retrieve infos from"),
...
CRAWL_THREADS_KWARG = {
    ...
    "required": False,
    "show_default": True,
    "help": ("The number of threads to run in parallel to crawl infos"),
}
...
DATABASE_NAME_KWARGS = {
    ...
    "required": True,
    "show_default": True,
    "help": ("house of the dabase drouot, christies, etc."),
}
...
TEXT_VECTOR_KWARGS = {
    ...
    "required": True,
    "show_default": True,
    "help": ("feature from the database to embed and query from"),
}
...
SELLER_KWARGS = {
    ...
    "required": True,
    "show_default": True,
    "help": ("seller, either drouot, christies or sothebys"),
}
...
START_DATE_KWARGS = {
    ...
    "required": False,
    "show_default": True,
    "help": ("Start date from which to crawl auctions from a defined website"),
}
...
END_DATE_KWARGS = {
    ...
    "required": False,
    "show_default": True,
    "help": ("End date from which to crawl auctions from a defined website"),
}
...
OBJECT_KWARGS = {
    ...
    "required": False,
    "show_default": True,
    "help": ("Kind of art object to create embedding & co"),
}
