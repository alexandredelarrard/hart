...
class Painting(BaseModel):
    ...
    is_painted_by_artist: str = Field(description="Is this painting painted by the artist ? Answer by True, False or None if not written. If painted by the school or copy of the artist then answer False. ")
    is_signed: str = Field(description="Is the painting signed by the artist ? Answer by True, False or None if not written")
    is_dated: str = Field(description="Is the painting dated ? Answer by True, False or None if not written")
    is_framed: str = Field(description="Is the painting framed ? Answer by True, False or None if not written")
    painting_length: str = Field(description="Length of the painting in cm. Convert to cm if necessary and always give the unit.")
    painting_width: str = Field(description="Width of the painting in cm. Convert to cm if necessary and always give the unit.")
    ...
    painting_condition: str = Field(description="Is the painting in good condition ? Is there scratches, holes, etc ?")
