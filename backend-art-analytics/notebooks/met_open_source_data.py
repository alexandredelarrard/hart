...
if __name__ == "__main__":
    ...
    training_text = pd.read_csv(r"C:\Users\alarr\Downloads\training_predicted.csv", sep=";")
    ...
    full_data = pd.read_sql("SELECT \"SELLER\", \"ID_ITEM\", \"ID_PICTURE\", \"URL_FULL_DETAILS\" FROM \"ALL_ITEMS_202403\"", con=context.db_con)
